...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://foundit-gcd6lwz88-meghiyats-projects.vercel.app",
        "https://foundit-41lgh0j49-meghiyats-projects.vercel.app",
    ],
    allow_origin_regex=r"https://foundit[^.]*(-[a-z0-9]+-meghiyats-projects)?\.vercel\.app",
